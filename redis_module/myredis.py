...
Specifying custom connection parameters
    redis_instance2 = MyRedis(host='example.com', port=6380, db=1, password='password123')
...
Get all items and return the result
    ...
    values = redis_instance.string_get("192.168.20.73")
    print(values)

    redis_instance.set_add("peter", "peter1", "peter2", "peter3")

    peter = redis_instance.set_get("peter")
    print(peter)
